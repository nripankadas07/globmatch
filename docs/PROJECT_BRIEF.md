        ...
        globmatch exists to solve a narrow, inspectable developer-tooling problem:
        ...
        Topics: extglob, fnmatch, glob, globstar, pattern-matching, python, zero-dependencies
